...
export default function VisionMission() {
  return (
    <section id="vision" className="py-5 bg-light border-top border-bottom">
        ...
        <div className="row g-4">
          <div className="col-md-6 animate__animated animate__fadeInUp">
            <div className="card h-100 p-5 border-0 shadow-sm rounded-4 custom-card-glow">
              <div className="bg-primary text-white rounded-3 p-3 d-inline-block mb-4"><FaEye size={32} /></div>
          ...
          <div className="col-md-6 animate__animated animate__fadeInUp animate__delay-1s">
            <div className="card h-100 p-5 border-0 shadow-sm rounded-4 custom-card-glow">
              <div className="bg-success text-white rounded-3 p-3 d-inline-block mb-4"><FaBullseye size={32} /></div>
